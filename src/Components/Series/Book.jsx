  ...
  return (
    <div>
      <section className="hidden sm:block">
        <div>
          <div>
            <div className="absolute top-[240%]">
          ...
          <div className="absolute text-center w-full top-[250%] ">
          ...
          {/* Cart Image */}
          <div className="absolute flex gap-4 top-[320%] w-full justify-center ">
            <div className="">
              <img
                src="/Book/cart.png"
                alt="The book that inspired the series"
      ...
      <section className="sm:hidden">
        <div>
          <div>
            <svg
              className="absolute top-[210%] w-full h-[1200px]"
          ...
          <div className="absolute text-center w-full top-[223%] ">
          ...
          {/* Cart Image */}
          <div className="absolute flex gap-4 top-[294%] w-full justify-center ">
            <div className="">
              <img
                src="/Book/cart.png"
                alt="The book that inspired the series"
