    ...
    <div className="h-screen ">
      <section>
        ...
        <div className="hidden sm:block">
          <div className="absolute top-[193%] right-[19%]">
          ...
          <div className="absolute w-fit left-26 top-[223%]">
          ...
          <div className="absolute w-fit -rotate-10 -left-[1%] top-[208%]">
            <div className="flex w-full">
        ...
        <div className=" sm:hidden  w-full h-screen bg-white">
          ...
          <div className="absolute top-[208%] right-[5%]">
            <img src="/Video/about.png" />
          </div>

          <div className="absolute top-[215%] w-full">
            <div className="flex justify-center ml-[12%] tems-center">
          ...
          <div className="absolute top-[247%] w-full flex justify-center">
          ...
          <div>
            ...
            <div className="sm:hidden absolute top-[244%] w-full left-0 flex flex-col items-center">
