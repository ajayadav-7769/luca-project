    ...
    <div>
      <section className="sm:block hidden">
        <div>
          ...
          <div className="absolute text-center  top-[335%]">
            {/* Text Above Heading */}
            ...
            <div className="absolute -top-[30%] right-[17%] ">
              <img
                src="/hero.png"
      ...
      <section className="sm:hidden">
        <div>
          ...
          <div className="absolute text-center  top-[430%] ">
            {/* Text Above Heading */}
            ...
            {/* Hero Image */}
            <div className="absolute -top-[22%] rotate-5 left-[40%]">
              <img
                src="/hero.png"
